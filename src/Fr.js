...
class Buttek extends Component { 
constructor(props){
		super(props);
  ...
  if(nextProps.time!==this.props.time){
   if(this.props.session===null){localStorage.clear();
	...
	render(){
		...
		<Buttek dt1={this.state.dt1} dt2={this.state.dt3} dt3={this.state.dt3} http={this.props.http} name="Ok"/>
		...
		<Buttek dt1={this.state.dt1} dt2={this.state.dt2} http={this.props.http} name="Log in"/>
